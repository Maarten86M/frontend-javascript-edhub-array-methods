...
const born16thCentury = inventors.filter((century) => {
  return century.year >= 1500 && century.year <= 1600;
})

console.log(born16thCentury);
...
const birthAray = inventors.map((birth) => {
  return birth.year;
});
console.log(birthAray);
...
const firstPlusLast = inventors.map((name) => {
...
console.log("jaren gesorteerd", sortYears);
...
console.log("langst geleefd", longLives);
...
const findEdison = inventors.find((edison) => {
  return edison.last === "Edison";
})

console.log("find edison",findEdison);